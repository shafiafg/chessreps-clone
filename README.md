# v1
## This is just the backend the part where it takes the openeings and know what to do with them it does not include any front end. 
## at the moment it has only 2 openeings which are hardcoded to have a look like chessreps with analyzations and why do a move. 
## if anyone wants to use this to make a full clone of chessreps dont waste your time this is just a test..
# v2
